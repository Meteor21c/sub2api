...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	availabilityV2Repository := repository.NewAvailabilityV2Repository(db)
	...
	accountTestService := service.ProvideAccountTestService(accountRepository, groupRepository, geminiTokenProvider, claudeTokenProvider, grokTokenProvider, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService, openAIGatewayService, gatewayService, settingService, pluginManager, billingService)
	availabilityV2Service := service.ProvideAvailabilityV2Service(availabilityV2Repository, accountRepository, groupRepository, concurrencyService, accountTestService)
	...
	availabilityV2Handler := admin.NewAvailabilityV2Handler(availabilityV2Service)
	upstreamBillingProbeService := service.ProvideUpstreamBillingProbeService(accountRepository, accountTestService, settingService, leaderLockCache, db)
	ollamaCloudUsageService := service.ProvideOllamaCloudUsageService(accountRepository, httpUpstream, settingService, secretEncryptor, configConfig, leaderLockCache, db)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, availabilityV2Handler, upstreamBillingProbeService, ollamaCloudUsageService)

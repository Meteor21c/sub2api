...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyAuthSourceDefaultOIDCConcurrency:          "10",
		...
		SettingKeyAuthSourceDefaultWeChatConcurrency:        "10",
		...
		SettingKeyAuthSourceDefaultGitHubConcurrency:        "10",
		...
		SettingKeyAuthSourceDefaultGoogleConcurrency:        "10",
		...
		SettingKeyAuthSourceDefaultDingTalkConcurrency:      "10",

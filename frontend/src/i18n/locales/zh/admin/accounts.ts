export default {
    accounts: {
      ...
      channelTest: {
        ...
        progress: '{completed}/{total} · 成功 {success} · 失败 {failed}',
        testAll: '测试全部 {count} 个模型',
        testMatching: '测试匹配的 {count} 个模型',
        testSelected: '测试选中 ({count})',
        refreshModels: '刷新模型',
        clearResults: '清除结果',
        filterModels: '筛选模型',
        selectAll: '选择全部模型',
        selectModel: '选择模型 {model}',
        testModel: '测试模型 {model}',
        model: '模型',
        status: '状态',
        result: '结果',
        actions: '操作',
        ...
        stopping: '正在停止…',
        stop: '停止批量测试',
        noModels: '该账号没有可测试的模型。',
        noMatchingModels: '没有匹配的模型。',
        loadFailed: '模型列表加载失败。',
        noResponseBody: '测试没有返回响应流。',
        noAccount: '账号不存在。',
        incomplete: '测试未返回完成状态。',
        cancelled: '已取消',
        usingModel: '使用模型：{model}',
        mediaReceived: '已收到媒体结果',
        responseTime: '耗时 {ms} ms',
        batchSkippedMedia: '批量测试已跳过 {count} 个图片/视频模型；如需验证请单独测试。',
        costHint: '测试会调用上游；图片或视频模型可能产生上游费用。'
      },
      // Stats Modal
      viewStats: '查看统计',

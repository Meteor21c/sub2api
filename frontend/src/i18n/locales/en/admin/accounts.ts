export default {
    accounts: {
      ...
      channelTest: {
        title: 'Test Channel',
        modelCount: '{count} models',
        progress: '{completed}/{total} · {success} succeeded · {failed} failed',
        testAll: 'Test all {count} models',
        testMatching: 'Test {count} matching models',
        testSelected: 'Test selected ({count})',
        refreshModels: 'Refresh models',
        clearResults: 'Clear results',
        filterModels: 'Filter models',
        selectAll: 'Select all models',
        selectModel: 'Select model {model}',
        ...
        failed: 'Failed',
        stopping: 'Stopping…',
        stop: 'Stop batch test',
        noModels: 'This account has no testable models.',
        noMatchingModels: 'No matching models.',
        loadFailed: 'Failed to load model list.',
        noResponseBody: 'The test returned no response stream.',
        noAccount: 'Account not found.',
        incomplete: 'The test ended without a completion status.',
        cancelled: 'Cancelled',
        usingModel: 'Using model: {model}',
        mediaReceived: 'Media result received',
        responseTime: '{ms} ms',
        batchSkippedMedia: 'Skipped {count} image/video model(s) in the batch; test them individually if needed.',
        costHint: 'Tests call the upstream; image or video models may incur upstream charges.'
      },
      // Stats Modal

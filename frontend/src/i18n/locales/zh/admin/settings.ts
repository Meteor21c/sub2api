export default {
    settings: {
      ...
      payment: {
        ...
        rechargeFeeTiers: '分档手续费/优惠',
        rechargeFeeTiersHint: '按充值金额生效；正数为手续费，负数为优惠。',
        rechargeFeeTiersEmpty: '未设置分档，使用上面的统一费率。',
        addRechargeFeeTier: '添加档位',
        removeRechargeFeeTier: '删除',
        rechargeFeeTierMin: '起始金额',
        rechargeFeeTierRate: '费率',
        orderTimeout: '订单超时时间',

<template>
  <AppLayout>
    ...
    <ChannelTestModal :show="showChannelTest" :account="channelTestingAcc" @close="closeChannelTestModal" />
    <AccountStatsModal :show="showStats" :account="statsAcc" @close="closeStatsModal" />
    <ScheduledTestsPanel :show="showSchedulePanel" :account-id="scheduleAcc?.id ?? null" :model-options="scheduleModelOptions" @close="closeSchedulePanel" />
    <AccountActionMenu :show="menu.show" :account="menu.acc" :position="menu.pos" @close="menu.show = false" @test="handleTest" @test-channel="handleChannelTest" @stats="handleViewStats" @schedule="handleSchedule" @duplicate="handleDuplicateAccount" @reauth="handleReAuth" @refresh-token="handleRefresh" @recover-state="handleRecoverState" @reset-quota="handleResetQuota" @set-privacy="handleSetPrivacy" @create-spark-shadow="handleCreateSparkShadow" />
...
import ChannelTestModal from '@/components/admin/account/ChannelTestModal.vue'
...
const channelTestingAcc = ref<Account | null>(null)
...
const closeChannelTestModal = () => { showChannelTest.value = false; channelTestingAcc.value = null }
...
const handleChannelTest = async (a: AccountListItem) => {
  const account = await loadAccountDetails(a)
  if (!account) return
  channelTestingAcc.value = account
  showChannelTest.value = true
}
